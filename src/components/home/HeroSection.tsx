...
const HeroSection: React.FC = () => (
  <section className="py-32 bg-steel-gray text-center">
    ...
    >
      ...
      <p className="text-xl text-metallic-silver mb-8 leading-relaxed">
      ...
      <a href="#contact">
        <button className="bg-cobalt-blue hover:bg-cobalt-blue-alt text-white font-medium text-lg px-8 py-3 rounded-lg transition-colors shadow-lg">
          Get In Touch
        </button>
      </a>
    </motion.div>
