  ...
  return (
    <div className="min-h-screen bg-[#232a32] font-sans">
      <section className="py-24">
        <div className="max-w-3xl mx-auto px-8 bg-white" style={{borderRadius:0}}>
          <motion.h1
          ...
          <motion.p
            className="mb-8 text-lg text-black font-mono"
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            ...
            <ul className="list-disc pl-6 space-y-2 font-mono text-black">
